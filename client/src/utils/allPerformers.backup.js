...
const allPerformers = (net, game, score, gor, handleInputChange, getDefaultValue, addExtra, showInput, props) => {
    ...
    if (score === EXTRA_POINT) {
        const checkDefaultVal = (defaultVal, selectedTeam, shortNet) => {
            // console.log("default val = ", defaultVal);
            let classList = "extra d-flex";
            if(shortNet === true) classList = classList + " short-net-player";
            if (defaultVal && defaultVal <= 1) {
                return (
                    <div className={classList}>
                        <img src='/icon/extra.svg' alt="img" onClick={e => addExtra(e, selectedTeam, game, props.roundNum)} className="extra-icon" />
                        <input type="text" style={{ display: showInput(selectedTeam, game, props.roundNum) }}
                            onChange={e => handleInputChange(e, null, game, score, net._id, true, null, selectedTeam, false, null)} className="extra-input form-control" />
                    </div>
                );
            } else {
                return null;
        ...
        if (net.performance.length < 4) {
            // return (<div className="net-less-four">{net.performance.map((p, j) => <div className="short-net-player" key={j}>  <input type="text" className="form-control extra-point" onChange={e => handleInputChange(e, null, game, score, net._id, true, null, p._id, false, null)} /> </div>)}</div>);
            return(<div className="net-less-four">{net.performance.map((p, j)=> checkDefaultVal(getDefaultValue(p, POINT, game, props.roundNum), [p._id], true))}</div>)
            ...
            //                         onChange={e => handleInputChange(e, null, game, score, net._id, true, null, p._id, false, null)} className="extra-input form-control" />
            //                 </div>
            //             </React.Fragment>)}
            //         </div>
            ...
            if (gor === 1) {
                ...
                const team = { player1: one, player2: four };
                // console.log(one);
                // console.log(score);
                // console.log(game);
                ...
                return (<div className="player-score d-flex flex-column">
                    <div className="two-p-input two-p-i-1">
                        {/* {getDefaultValue(one, score, game, props.roundNum) < 1 ? null : (<input className="form-control" type="text" onChange={e => handleInputChange(e, null, game, score, net._id, true, null, one._id, false, null)} />)} */}
                        {/* {checkDefaultVal(getDefaultValue(one, score, game, props.roundNum), <input className="form-control" type="text" onChange={e => handleInputChange(e, null, game, score, net._id, true, null, one._id, false, null)} />)} */}
                        {checkDefaultVal(getDefaultValue(one, POINT, game, props.roundNum), [one._id, four._id], false)}
                    </div>
                    <div className="line"></div>

                    <div className="two-p-input two-p-i-2">
                        {/* <input className="form-control" type="text"
                            onChange={e => handleInputChange(e, one, game, score, net._id, false, two, null, false, 2, gor)}
                            defaultValue={getDefaultValue(net.performance[1], score, game, props.roundNum)} /> */}
                        {checkDefaultVal(getDefaultValue(two, POINT, game, props.roundNum), [two._id, three._id], false)}
                    </div>
                </div>);
                ...
                //                         // onChange={e => handleInputChange(e, one._id, game, score, net._id, true)} className="extra-input form-control" />
                //                         onChange={e => handleInputChange(e, null, game, score, net._id, true, null, one._id, false, null)} className="extra-input form-control" />
                //                 </div>
                //             </React.Fragment>)}
                //         </div>
                ...
                //                         onChange={e => handleInputChange(e, null, game, score, net._id, true, null, four._id, false, null)} className="extra-input form-control" />
                //                 </div>
                //             </React.Fragment>)}
                //         </div>
                ...
                //                         onChange={e => handleInputChange(e, null, game, score, net._id, true, null, two._id, false, null)} className="extra-input form-control" />
                //                 </div>
                //             </React.Fragment>)}
                //         </div>
                ...
                //                         onChange={e => handleInputChange(e, null, game, score, net._id, true, null, three._id, false, null)} className="extra-input form-control" />
                //                 </div>
                //             </React.Fragment>)}
                //         </div>
