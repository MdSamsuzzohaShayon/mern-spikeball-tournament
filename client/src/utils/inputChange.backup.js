import { POINT, SCORE, EXTRA_POINT } from './global';
// const pointVal = 1;
...
function inputChange(e, netID, game, scoreType, isExtra, team, oponent, updateTeam, setUpdateTeam, extraPlayerId, individual, teamNum, updatePerformance, setUpdatePerformance) {
    // console.log(POINT_DIFFERENTIAL, POINT, SCORE);
    ...
    // ADD EXTRA POINT 
    if (isExtra === true && scoreType === EXTRA_POINT) {
        // // ADD EXTRA POINT - OR AWARD POINT 
