...
import { hostname, getDefaultValue } from '../../../utils/global';
...
function Round(props) {
    ...
    return (
        <div className="Round1">
            {props.initialize && <button className="btn btn-primary" onClick={initializeNetHandler} >Initialize Net</button>}
            <button className="btn btn-primary" onClick={reinitializeNetHandler} >Reinitialize Net</button>
            <br />
