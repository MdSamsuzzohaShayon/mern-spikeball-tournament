...
function Round528(props) {
    ...
    const initializeNetHandler = async () => {
        ...
        const response = await fetch(`${hostname}/api/event/assign-fifth-net/${props.eventID}/${props.round}`, requestOptions);
    ...
    return (
        <div className="Round124">
            {props.initialize && <button className="btn btn-primary" onClick={initializeNetHandler} >Reassign net for round 5 to 8</button>}
            <br />
