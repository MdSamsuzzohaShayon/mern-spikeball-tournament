...
### 📜 REPLY 
 - IF YOU UPDATE THIS ON EVERY INPUT CHANGE, THIS APPLICATION WILL BE VERY SLOW SINCE YOU HAVE THE ABILITY TO UPDATE MULTIPLE DOCUMENT ON DATABASE. I MADE A FUNCTION FOR ON CLOSE EVENT THAT MEANS IF YOU TRY TO CLOSE THE TAB OR BROWSER IT WILL ASK YOU "CHANGE YOU MADE MAY NOT SAVE"
 - Sir i have a request. This project js almost done, Now I can't concentrat
