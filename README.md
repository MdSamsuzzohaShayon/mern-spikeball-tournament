...
### 5 - CHANGE REQUIREMENTS
 ...
 - PRESS TAB BUTTON SEQUENTIALLY - NET 1 GAME 1, NET 2 GAME 1, NET 3 GAME 1, SO ON
 ...
 - MAKE CHANGE ON SINGLE EVENT
 - AUTHENTICATE BACKEND AND MAKE MORE SECURE
 - NAME NEED TO BE BLUE IF BOTH TEAM HAS SAME NUMBER
 - SELECT ALL SCORE INPUT AND SET ID ONE BY ONE WITH UNIQUE VALUE - USE EFFECT, QUERY SELECTOR ALL, SET ATTRIBUTE
