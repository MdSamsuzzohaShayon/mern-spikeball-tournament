...
### 7 - CHANGE REQUIREMENTS
 - IN PLACE OF PLUS BUTTON (FOR EXTRA POINT) THERE WILL BE INPUT FIELD WITH DEFAULT VALUE, AND INSDEX TAB SEQUENTIALLY
 ...
 - STICKY HEADER OF SCORE TABLE, AND SUBMIT BUTTON ON THE MIDDLE
